...
class HandOverHandler: HandOver {
    ...
    override func startChat(_ chatHandlerParams: [String : Any]?) {
        ...
        system?.configuration = self.chatHandlerProvider?.configuration(for: .SystemMessageElement) as! MessageConfiguration
    ...
    override func postStatement(_ statement: StorableChatElement) {
        ...
        statement.configuration = self.chatHandlerProvider?.configuration(for: .OutgoingElement) as! MessageConfiguration
